const Keyboard = {
  ...
  init() {
    document.querySelector('.keyboard__keys').appendChild(this.createKeys());

    this.elements.keys = document.querySelectorAll('.keyboard__button_short');
  },
  ...
  handleKeyDown() {
    document.addEventListener('keydown', (event) => {
      ...
      const textarea = document.querySelector('.search__input');
      let allowed;
