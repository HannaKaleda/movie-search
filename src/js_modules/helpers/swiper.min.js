...
!(function (e, t) {
  ...
  const r = {
    ...
    attr(e, t) {
      ...
      for (let s = 0; s < this.length; s += 1) {
        ...
        else { for (const a in e) (this[s][a] = e[a]), this[s].setAttribute(a, e[a]); }
      }
      return this;
    },
    removeAttr(e) {
      ...
      function l(e) {
        ...
        if (t) {
          ...
          if ((i.indexOf(e) < 0 && i.unshift(e), s(t).is(r))) n.apply(t, i);
            ...
            for (let a = s(t).parents(), o = 0; o < a.length; o += 1) { s(a[o]).is(r) && n.apply(a[o], i); }
          }
        }
      }
      function d(e) {
    ...
    trigger() {
      ...
      for (let a = i[0].split(' '), r = i[1], n = 0; n < a.length; n += 1) {
        for (let o = a[n], l = 0; l < this.length; l += 1) {
          ...
          (d.dom7EventData = i.filter((e, t) => t > 0)),
          d.dispatchEvent(h),
          (d.dom7EventData = []),
    ...
    css(e, i) {
      ...
      if (arguments.length === 1) {
        if (typeof e !== 'string') {
          for (s = 0; s < this.length; s += 1) { for (const a in e) this[s].style[a] = e[a]; }
          return this;
        }
    ...
    append() {
      ...
      for (let r = 0; r < s.length; r += 1) {
        ...
        for (let n = 0; n < this.length; n += 1) {
          ...
          } else if (t instanceof i) { for (let l = 0; l < t.length; l += 1) this[n].appendChild(t[l]); } else this[n].appendChild(t);
        }
      }
      return this;
    },
    ...
    parents(e) {
      for (var t = [], i = 0; i < this.length; i += 1) {
        for (let r = this[i].parentNode; r;) { e ? s(r).is(e) && t.push(r) : t.push(r), (r = r.parentNode); }
      }
      return s(a(t));
    },
    closest(e) {
    ...
    find(e) {
      for (var t = [], s = 0; s < this.length; s += 1) {
        for (let a = this[s].querySelectorAll(e), r = 0; r < a.length; r += 1) { t.push(a[r]); }
      }
      return new i(t);
    },
    children(e) {
  ...
  (l.installModule = function (e) {
    ...
    const a = e.name || `${Object.keys(s.prototype.modules).length}_${n.now()}`;
    return (
  ...
  const h = {
        ...
        for (
          ...
          if ($.css('display') !== 'none') {
            if (e.slidesPerView === 'auto') {
              const H = t.getComputedStyle($[0], null);
              const B = $[0].style.transform;
              const N = $[0].style.webkitTransform;
              if (
                (B && ($[0].style.transform = 'none'),
                N && ($[0].style.webkitTransform = 'none'),
                e.roundLengths)
              ) { S = this.isHorizontal() ? $.outerWidth(!0) : $.outerHeight(!0); } else if (this.isHorizontal()) {
                const X = parseFloat(H.getPropertyValue('width'));
                const V = parseFloat(H.getPropertyValue('padding-left'));
                const Y = parseFloat(H.getPropertyValue('padding-right'));
                const F = parseFloat(H.getPropertyValue('margin-left'));
                const W = parseFloat(H.getPropertyValue('margin-right'));
                const R = H.getPropertyValue('box-sizing');
                S = R && R === 'border-box' ? X + F + W : X + V + Y + F + W;
              } else {
                const q = parseFloat(H.getPropertyValue('height'));
                const j = parseFloat(H.getPropertyValue('padding-top'));
                const K = parseFloat(H.getPropertyValue('padding-bottom'));
                const U = parseFloat(H.getPropertyValue('margin-top'));
                const _ = parseFloat(H.getPropertyValue('margin-bottom'));
                const Z = H.getPropertyValue('box-sizing');
    ...
    updateActiveIndex(e) {
      ...
      if (a.indexOf(i) >= 0) t = a.indexOf(i);
        ...
        const c = Math.min(r.slidesPerGroupSkip, h);
    ...
    updateClickedSlide(e) {
      ...
      let a = !1;
      if (i) {
        for (let r = 0; r < this.slides.length; r += 1) { this.slides[r] === i && (a = !0); }
      }
  ...
  const u = {
    slideTo(e, t, i, s) {
      ...
      if ((r.updateProgress(g), o.normalizeSlideIndex)) {
        for (let b = 0; b < d.length; b += 1) { -Math.floor(100 * g) >= Math.floor(100 * d[b]) && (n = b); }
      }
    ...
    slideNext(e, t, i) {
      ...
      const r = this.activeIndex < s.slidesPerGroupSkip ? 1 : s.slidesPerGroup;
      if (s.loop) {
        if (a) return !1;
    ...
    slideToClosest(e, t, i, s) {
      ...
      const r = Math.min(this.params.slidesPerGroupSkip, a);
      const n = r + Math.floor((a - r) / this.params.slidesPerGroup);
      const o = this.rtlTranslate ? this.translate : -this.translate;
      if (o >= this.snapGrid[n]) {
        const l = this.snapGrid[n];
        o - l > (this.snapGrid[n + 1] - l) * s
          && (a += this.params.slidesPerGroup);
      } else {
        const d = this.snapGrid[n - 1];
  ...
  const v = {
    loopCreate() {
      ...
      for (let p = 0; p < h.length; p += 1) { a.append(s(h[p].cloneNode(!0)).addClass(i.slideDuplicateClass)); }
      for (let c = d.length - 1; c >= 0; c -= 1) { a.prepend(s(d[c].cloneNode(!0)).addClass(i.slideDuplicateClass)); }
    },
    loopFix() {
  ...
  const L = {
    appendSlide(e) {
      ...
      ) { for (let s = 0; s < e.length; s += 1) e[s] && t.append(e[s]); } else t.append(e);
  ...
  const I = ((m = t.navigator.platform),
  ...
  function D(i) {
    ...
    if (!this.animating || !r.preventInteractionOnTransition) {
      ...
      if (
        ...
        ) { this.allowClick = !0; } else if (!r.swipeHandler || d.closest(r.swipeHandler)[0]) {
    ...
    if (
      ...
      if (s.freeMode) {
        ...
        if (s.freeModeMomentum) {
          ...
          let T;
          let E = !1;
          const S = 20 * Math.abs(t.velocity) * s.freeModeMomentumBounceRatio;
          if (y < t.maxTranslate()) {
            ...
            y = -(y = Math.abs(d[C] - y) < Math.abs(d[C - 1] - y)
        ...
        for (
          ...
          const I = L < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
          void 0 !== l[L + I]
            ? p >= l[L] && p < l[L + I] && ((k = L), ($ = l[L + I] - l[L]))
            : p >= l[L] && ((k = L), ($ = l[l.length - 1] - l[l.length - 2]));
        }
        const D = (p - l[k]) / $;
        const O = k < s.slidesPerGroupSkip - 1 ? 1 : s.slidesPerGroup;
        if (u > s.longSwipesMs) {
          ...
          if (o && this.currentBreakpoint !== o) {
            ...
            l
                && [
                  ...
                  const t = l[e];
                  void 0 !== t
                    && (l[e] = e !== 'slidesPerView' || (t !== 'AUTO' && t !== 'auto')
                      ? e === 'slidesPerView'
                        ? parseFloat(t)
                        : parseInt(t, 10)
                      : 'auto');
  ...
  const W = (function (e) {
    function t() {
      ...
      Object.keys(h.modules).forEach((e) => {
        const t = h.modules[e];
        if (t.params) {
    ...
    init() {
      if (o.observer && this.params.observer) {
        if (this.params.observeParents) {
          for (let e = this.$el.parents(), t = 0; t < e.length; t += 1) { this.observer.attach(e[t]); }
        }
  ...
  const Q = {
    ...
    appendSlide(e) {
      if (typeof e === 'object' && 'length' in e) {
        for (let t = 0; t < e.length; t += 1) { e[t] && this.virtual.slides.push(e[t]); }
    ...
    prependSlide(e) {
      ...
      let s = 1;
      if (Array.isArray(e)) {
        for (let a = 0; a < e.length; a += 1) { e[a] && this.virtual.slides.unshift(e[a]); }
  ...
  var ie = {
    ...
    handle(e) {
      ...
      let o = 0;
      const l = i.rtlTranslate ? -1 : 1;
      const d = ie.normalize(t);
      if (a.forceToAxis) {
        if (i.isHorizontal()) {
      ...
      if ((a.invert && (o = -o), i.params.freeMode)) {
        ...
        const p = i.mousewheel.lastEventBeforeSnap;
        const c = p
              && h.time < p.time + 500
              && h.delta <= p.delta
        ...
        if (!c) {
          ...
          let u = i.getTranslate() + o * a.sensitivity;
          const v = i.isBeginning;
          const f = i.isEnd;
          if (
            ...
            const m = i.mousewheel.recentWheelEvents;
            m.length >= 15 && m.shift();
            const g = m.length ? m[m.length - 1] : void 0;
            const b = m[0];
            if (
              (m.push(h),
        ...
        const x = i.mousewheel.recentWheelEvents;
        x.length >= 2 && x.shift();
        const T = x.length ? x[x.length - 1] : void 0;
        if (
          (x.push(y),
          T
  ...
  const ae = {
    update() {
      ...
      if (
        ...
        let i;
        const a = this.virtual && this.params.virtual.enabled
        ...
        if (
          ...
          if (
            (t.dynamicBullets
                ...
                (d = ((l = o + (Math.min(h.length, t.dynamicMainBullets) - 1))
                    + o)
                  / 2)),
            h.removeClass(
              `${t.bulletActiveClass
          ...
          if (t.dynamicBullets) {
            ...
            const b = (this.pagination.bulletSize * g
  ...
  const re = {
    ...
    updateSize() {
      if (this.params.scrollbar.el && this.scrollbar.el) {
        ...
        (s = this.params.scrollbar.dragSize === 'auto'
          ? a * r
    ...
    setDragPosition(e) {
      ...
      (t = (i.getPointerPosition(e)
            - a.offset()[this.isHorizontal() ? 'left' : 'top']
            - (o !== null ? o : r / 2))
          / (n - r)),
      (t = Math.max(Math.min(t, 1), 0)),
      s && (t = 1 - t);
      const l = this.minTranslate() + (this.maxTranslate() - this.minTranslate()) * t;
    ...
    onDragStart(e) {
      ...
      (this.scrollbar.dragStartPos = e.target === r[0] || e.target === r
    ...
    onDragEnd(e) {
      ...
      this.scrollbar.isTouched
          ...
          t.hide
            && (clearTimeout(this.scrollbar.dragTimeout),
            (this.scrollbar.dragTimeout = n.nextTick(() => {
  ...
  var oe = {
    ...
    onTouchStart(e) {
      ...
      i.$imageEl
          ...
          && (s.isTouched
            ...
            (s.isTouched = !0),
            (s.touchesStart.x = e.type === 'touchstart' ? e.targetTouches[0].pageX : e.pageX),
            (s.touchesStart.y = e.type === 'touchstart' ? e.targetTouches[0].pageY : e.pageY)));
    },
    onTouchMove(e) {
      const t = this.zoom;
      const i = t.gesture;
      ...
      if (
        ...
        if (!(r < i.slideWidth && o < i.slideHeight)) {
          if (
            ...
            (s.maxY = -s.minY),
            (s.touchesCurrent.x = e.type === 'touchmove' ? e.targetTouches[0].pageX : e.pageX),
            (s.touchesCurrent.y = e.type === 'touchmove' ? e.targetTouches[0].pageY : e.pageY),
          ...
          (a.x = (s.touchesCurrent.x - a.prevPositionX)
                / (Date.now() - a.prevTime)
                / 2),
          (a.y = (s.touchesCurrent.y - a.prevPositionY)
                / (Date.now() - a.prevTime)
                / 2),
    ...
    enable() {
      ...
      if (!e.enabled) {
        ...
        const s = `.${this.params.slideClass}`;
        o.gestures
  ...
  const le = {
    loadInSlide(e, t) {
      ...
      if (void 0 !== e && i.slides.length !== 0) {
        const r = i.virtual && i.params.virtual.enabled
    ...
    load() {
      ...
      } else if (l > 1) { for (let p = r; p < r + l; p += 1) d(p) && e.lazy.loadInSlide(p); } else e.lazy.loadInSlide(r);
      if (o.loadPrevNext) {
  ...
  var de = {
    ...
    setTranslate(e, t) {
      ...
      if (Array.isArray(r)) {
        for (let o = 0; o < r.length; o += 1) { r[o] !== t && r[o] instanceof W && n(r[o]); }
  ...
  const be = {
    ...
    update(e) {
      ...
      if (t) {
        const i = t.params.slidesPerView === 'auto'
          ? t.slidesPerViewDynamic()
          : t.params.slidesPerView;
        const s = this.params.thumbs.autoScrollOffset;
        const a = s && !t.params.loop;
        ...
        let h = 1;
        const p = this.params.thumbs.slideThumbActiveClass;
        if (
          ...
          for (let u = 0; u < h; u += 1) { t.slides.eq(this.realIndex + u).addClass(p); }
        }
      }
    },
  };
